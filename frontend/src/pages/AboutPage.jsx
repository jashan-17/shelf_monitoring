...
const workflowNotes = [
  ...
  "dbt and Airflow handle analytics workflows",
];
  ...
  return (
    <section className="page-section">
      <PageHeader
        ...
        description="Image-based stock level classification for retail shelf monitoring with live prediction, saved results, and analytics support."
      />
      ...
      <div className="about-hero card">
        <div className="about-hero-copy">
          ...
          <p className="card-copy">
            ...
            results for historical reporting and downstream analytics.
          </p>
        </div>
      ...
      <div className="about-section-grid">
        ...
        <div className="card about-content-card">
          ...
          <p className="card-copy">
            ...
            prediction, database save, dashboard views, and pipeline integration.
            Model performance is strongest on clear shelf images and can be improved
            further with more production-style training data.
          </p>
        </div>
      </div>
      ...
      <div className="card about-workflow-card">
        <div className="section-heading">
          <h3>How It Works</h3>
          <p className="card-copy">Image → Model → Prediction → Database → Dashboard</p>
        </div>
      ...
      <div className="about-section-grid">
        ...
        <div className="card about-content-card">
          ...
          <h3>Production-style flow</h3>
          <p className="card-copy">
            Predictions are handled through the API, selected results are stored in
            PostgreSQL, and downstream analytics are supported by dbt and Airflow.
          </p>
        </div>
      </div>
    </section>
